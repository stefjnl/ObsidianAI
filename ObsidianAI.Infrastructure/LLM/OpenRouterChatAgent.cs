...
namespace ObsidianAI.Infrastructure.LLM
{
    ...
    public sealed class OpenRouterChatAgent : IChatAgent
    {
        ...
        /// </summary>
        public static async Task<OpenRouterChatAgent> CreateAsync(IOptions<AppSettings> appOptions, string instructions, System.Collections.Generic.IEnumerable<object>? tools = null)
        {
            return await Task.FromResult(new OpenRouterChatAgent(appOptions, instructions, tools));
        }
